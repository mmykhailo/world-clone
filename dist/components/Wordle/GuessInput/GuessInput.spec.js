...
describe("GuessInput Component", () => {
    it("renders input with correct properties", () => {
        ...
        render(_jsx(GuessInput, { index: 0, letter: "A", handleChange: mockHandleChange, handleKeyDown: mockHandleKeyDown, inputRefs: inputRefs }));
    ...
    it("calls handleChange when input value changes", () => {
        ...
        const mockHandleKeyDown = jest.fn();
        const inputRefs = { current: [] };
        render(_jsx(GuessInput, { index: 0, letter: "", handleChange: mockHandleChange, handleKeyDown: mockHandleKeyDown, inputRefs: inputRefs }));
        const input = screen.getByRole("textbox");
